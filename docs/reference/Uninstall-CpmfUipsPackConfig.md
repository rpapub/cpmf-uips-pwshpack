...
```
Uninstall-CpmfUipsPackConfig [-Force] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

## DESCRIPTION
Complements Install-CpmfUipsPackConfig.
Removes the config file and, if the
...
Without -Force, ShouldProcess governs
